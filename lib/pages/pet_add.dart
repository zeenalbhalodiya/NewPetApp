...
var controller = Get.put(DataController());
  ...
  Future _handleAddButton() async {
    ...
    String price = priceController.text;
     ...
     //    file: _image!);
     await controller.saveData(petModel:PetModel( name: name, price: price, age: age, imageLink: '', category: selectedCategory ?? '', description: description??'', favorite: []), file: _image!,);
